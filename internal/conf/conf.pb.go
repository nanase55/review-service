...
type Kafka struct {
	...
	ReviewStatusTopic string                 `protobuf:"bytes,3,opt,name=review_status_topic,json=reviewStatusTopic,proto3" json:"review_status_topic,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Kafka) GetReviewStatusTopic() string {
	if x != nil {
		return x.ReviewStatusTopic
	}
	return ""
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\xae\x02\n" +
	"\tBootstrap\x12*\n" +
	...
	"\relasticsearch\x18\x05 \x01(\v2\x19.kratos.api.ElasticsearchR\relasticsearch\x12'\n" +
	"\x05kafka\x18\x06 \x01(\v2\x11.kratos.api.KafkaR\x05kafka\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\"\xb6\x01\n" +
	...
	"\x12reviewAppeal_index\x18\x04 \x01(\tR\x11reviewAppealIndex\"l\n" +
	"\x05Kafka\x12\x18\n" +
	"\abrokers\x18\x01 \x03(\tR\abrokers\x12\x19\n" +
	"\bgroup_id\x18\x02 \x01(\tR\agroupId\x12.\n" +
	"\x13review_status_topic\x18\x03 \x01(\tR\x11reviewStatusTopicB#Z!review-service/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	6,  // 5: kratos.api.Bootstrap.kafka:type_name -> kratos.api.Kafka
